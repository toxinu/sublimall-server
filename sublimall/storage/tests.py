...
class PluginAPITestCase(TestCase):
    ...
    def _get_post_data(
        self, fields=["email", "api_key", "version", "package", "platform", "arch"]
    ):
        """
    ...
    def test_download_package_with_bad_form(self):
        ...
        self.assertEqual(
            j["errors"],
            ["Email is mandatory.", "API key is mandatory.", "Version is mandatory."],
        )
    ...
    def test_download_package_with_bad_credentials(self):
        ...
        """
        data = {"email": self.member.email, "api_key": "test", "version": 2}
