...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for u in orm.UserTemp.objects.all():
            m = orm.Member()
            m.email = u.email
            m.api_key = u.api_key
            m.is_staff = u.is_staff
            m.date_joined = u.date_joined
            ...
            for user_permission in u.user_permissions.all():
                m.user_permissions.add(user_permission)

            u.save()
            print('    * Restoring %s member' % u.email)
    ...
    models = {
        'accounts.member': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '40', 'null': 'True'}),
